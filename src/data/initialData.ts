...
export const INITIAL_POSTS: PostItem[] = [
  ...
  {
    id: 'post-2',
    author: 'Creative Ads Agency',
    authorAvatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&auto=format&fit=crop&q=80',
    role: 'marketing',
    price: '₹4,999/mo',
    moq: '1 Campaign',
    caption: 'High converting Meta & Google Ads management for e-commerce stores. Includes video ad design, copy, and ROAS optimization.',
